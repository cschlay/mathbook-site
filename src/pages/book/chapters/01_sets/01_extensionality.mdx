...
<Quoted>
  ...
  In general, when we have objects $a_1, \ldots, a_n$, then <tex value="\{a_1, \ldots, a_n\}"/> is _the_ set $S$ whose elements are
  $a_1, \ldots, a_n$.
...
<LatexExercise answer={/S = \\{ 2\^n \\mid n \\in \\mathbb{N} \\}/}>
